class calorieTracker{
    constructor() {
        ...
        document.getElementById('limit') = this._calorieLimit();
    }
     // Public methods/Api
...
class Meal{
    constructor(name, calories) {
        this.id = Math.random().toString(2).slice(2)
        this.name = name;
...
class App{
    ...
    _setLimit(e) {
        ...
        if (limit.value === '') {
            alert('please set calorie limit')
            return;
        }
        ...
        const modal = bootstrap.Modal.getIntance(modalEl);
        modal.hide();
